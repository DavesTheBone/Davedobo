...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['U SUCK!!!', 0.4], //From 20% to 39%
		['U SO DUMB', 0.5], //From 40% to 49%
		['Bruhhh', 0.6], //From 50% to 59%
		['Nahhh', 0.69], //From 60% to 68%
		['Nice', 0.7], //69%
	...
	public dynamic function updateScoreText()
	{
		...
		if(!instakillOnMiss) tempScore = Language.getPhrase('score_text', 'Score: {1} | Fails: {2} | You are: {3}', [songScore, songMisses, str]);
		else tempScore = Language.getPhrase('score_text_instakill', 'Score: {1} | You are: {2}', [songScore, str]);
